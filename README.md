...
- Использование CUPED с ковариатой в виде флага оплаты от 25.10 не дало увеличения мощности, так как корреляция между флагами оплаты в тесте и претесте оказалась близка к нулю. 
