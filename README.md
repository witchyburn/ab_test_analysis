...
6.  **Пост-оценка мощности теста:** метод Монте-Карло (многократное проведение Z-теста на семплированных выборках).
...
- Абсолютный прирост конверсии в тестовой группе составил +0.51 п.п., относительный прирост составил +9.4%, что с точки зрения бизнеса дает миллионный эффект с высокой ROMI.
- Полученный статистически значимый результат является надежным: мощность теста составляет порядка 81%, что выше общепринятого порога. 
